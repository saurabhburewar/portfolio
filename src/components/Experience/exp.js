            ...
            <div className="expTimelinebox">
                ...
                <div className="expCurrentbox">
                    <div className="expLogos">
                        <img src={deloitteimg} onClick={() => {setComp(data.deloitte)}} alt="Deloitte"></img>
                ...
                <div className="expPastbox1">
                    <div className="expLogos">
                        <img src={finezzaimg} onClick={() => {setComp(data.finezza)}} alt="Finezza"></img>
                ...
                <div className="expPastbox2">
                    <div className="expLogos">
                        <img src={upraisedimg} onClick={() => {setComp(data.upraised)}} alt="Upraised"></img>
